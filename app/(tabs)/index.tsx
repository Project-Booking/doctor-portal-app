...
import {
  ...
  GRAY_200, GRAY_400, GRAY_500, GRAY_600, GRAY_700, GRAY_900,
...
const upcomingAppointments = [
  { id: '1', name: 'Rony Brawa', type: 'Consultation', time: '09:00 AM', token: 'T01', status: 'confirmed' },
  { id: '2', name: 'Sarah Wilson', type: 'Follow-up', time: '10:30 AM', token: 'T02', status: 'confirmed' },
  { id: '3', name: 'Mike Johnson', type: 'Checkup', time: '11:00 AM', token: 'T03', status: 'pending' },
  { id: '4', name: 'Priya Sharma', type: 'Consultation', time: '12:00 PM', token: 'T04', status: 'pending' },
  { id: '5', name: 'Alex Chen', type: 'Follow-up', time: '02:00 PM', token: 'T05', status: 'confirmed' },
];
...
export default function HomeScreen() {
  ...
  const [activeSession, setActiveSession] = useState('Morning OP');
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.speciality}>Cardiologist • City Medical Center</Text>
          </View>
        ...
        >
          <StatCard icon="🏥" label="Total Patients" value="16,549" delta="+3.2%" positive />
          <StatCard icon="📋" label="Today's OPD" value="24" delta="6 pending" />
          <StatCard icon="✅" label="Completed" value="18" delta="75%" positive />
          <StatCard icon="❌" label="Cancelled" value="2" delta="-0.5%" />
        </ScrollView>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.activeSessionCard}>
            ...
            <View style={styles.activeSessionInfo}>
              <Text style={styles.activeSessionName}>{activeSession}</Text>
              <Text style={styles.activeSessionTime}>09:00 AM – 01:00 PM</Text>
              <Text style={styles.activeSessionSub}>Token running: T07 / 20</Text>
            </View>
            <TouchableOpacity style={styles.manageBtn} onPress={() => router.push('/booking' as any)}>
        ...
        <View style={styles.section}>
          ...
          {upcomingAppointments.map((appt) => {
            ...
            return (
              <TouchableOpacity key={appt.id} style={styles.apptRow} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  ...
  statusPill:  { paddingHorizontal: SPACE_SM, paddingVertical: 4, borderRadius: RADIUS_LG },
  statusPillText: { fontSize: FONT_SM - 1, fontWeight: '700' },
});